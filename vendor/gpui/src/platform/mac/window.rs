    ...
    unsafe {
        ...
        VIEW_CLASS = {
            ...
            unsafe {
                ...
                // Route trackpad pinch (NSEventTypeMagnify) into the generic
                // handler; without this the gesture dies before it can be
                // converted by MacEvent::from_native (see events.rs).
                decl.add_method(
